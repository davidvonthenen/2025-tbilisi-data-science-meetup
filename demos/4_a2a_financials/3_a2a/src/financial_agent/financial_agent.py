"""Financial agent that proxies requests to an OpenAI chat model."""
...
class FinancialAgent:
    """Interact with an OpenAI chat model to answer financial questions."""

    SYSTEM_INSTRUCTION = (
        "You are a financial assistant. "
        "You can provide financial information and answer questions related to stocks by specifying a stock ticker symbols. "
        "You can provide the most recent quarterly earnings results and also financial improvement from the previous quarter."
    )
    ...
    def __init__(
        ...
        *,
        ...
        self._model = model or os.getenv(
            "OPENAI_FINANCIAL_MODEL", os.getenv("OPENAI_MODEL", "gpt-5-nano")
        )
        ...
        #     },
        #     {
        #         "name": "mock_financial_alerts",
        #         "description": "Return pretend financial alerts for a region.",
        #         "parameters": {
        #             "type": "object",
        #             "properties": {
        #                 "region": {"type": "string"},
        ...
        #     },
        # ]
        logger.info("FinancialAgent initialized with model %s", self._model)
    ...
    async def ainvoke(self, query: str, session_id: str) -> dict[str, Any]:
        logger.debug("FinancialAgent.ainvoke query=%s session_id=%s", query, session_id)
        ...
        while True:
            ...
            content = choice.content or "I was unable to generate a response."
